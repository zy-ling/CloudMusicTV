(function () {
    ...
    NEJ.C = function () {
        ...
        var bid = {dv: 0, cz: 1, cR: 2, dm: 3, cY: 4, ht: 5, lO: 6, ft: 7}, td = {
            dC: 0,
            cB: 1,
            cV: 2,
            dw: 3,
...
(function () {
    ...
    var lp = bM.ek.prefix, bky = bM.bke, bKo = {
        scale: "scale({x|1},{y|1})",
        rotate: "rotate({a})",
...
(function () {
    ...
    bj.oz = dY.oz = function () {
        var bRC = function () {
            var tS = arguments, tw = bb.lr(tS[0]), bZz = ce[tw], bu = (tS[1] || "").toLowerCase(), be = tS[2];
            if (!bZz || !bu || !be)return;
            bZz = bZz[bu];
            if (!bZz)return;
            var bSK = !!tS[3], bv = bm.eg(bZz, function (iZ) {
    ...
    bj.ky = dY.ky = function () {
        var bly = function () {
            var tS = arguments, tw = bb.lr(tS[0]), bZz = ce[tw], ye = (tS[1] || "").toLowerCase();
            if (!bZz || !ye)return;
            var bC = bb.bG(tw);
...
(function () {
    ...
    bb.blH = dY.blH = function (bC) {
        ...
        var bZz = document.body.scrollHeight, ye = document.documentElement.scrollHeight;
    ...
    bb.qr = function () {
        ...
        return function (uq) {
            var blM = uq || document, xV = blM.body, xQ = blM.documentElement, bp = {
...
(function () {
    ...
    bm.nc = function () {
        ...
        }, cbA = ["上午", "下午"], cbz = ["A.M.", "P.M."], baR = ["日", "一", "二", "三", "四", "五", "六"], cby = ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"], cbu = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"];
        var Hy = function (gk) {
            gk = parseInt(gk) || 0;
            return (gk < 10 ? "0" : "") + gk
        };
    ...
    bm.cdw = function (gk, gM) {
        var caE = ("" + gk).length, caD = Math.max(1, parseInt(gM) || 0), cjL = caD - caE;
        if (cjL > 0) {
...
(function () {
    ...
    bc.cz = function (bf) {
        ...
        NEJ.EX(this.qG, bf);
        var zl = jf.bG("csrf");
        if ((/^\/[^\/]/.test(this.qG.url) || this.qG.url.indexOf(location.protocol + "//" + location.host) == 0) && !!zl.cookie && !!zl.param) {
...
(function () {
    ...
    cX = {
        ...
        def: {
            "if": {pfix: bZg, sfix: "){", pmin: 1},
            "else": {pfix: "}else{"},
            elseif: {pfix: bZd, sfix: "){", pdft: "true"},
            "/if": {pfix: "}"},
            "for": {pfix: bZD, pmin: 3},
            forelse: {pfix: bZC},
            "/for": {pfix: bZB},
            list: {pfix: bZA, pmin: 3},
            "/list": {pfix: "};"},
            "break": {pfix: "break;"},
            "var": {pfix: bZa, sfix: ";"},
            macro: {pfix: bZw},
...
(function () {
    ...
    bgU.dJ = function (bf) {
        ...
        if (!hQ) {
            ...
            bb.rW({
                hidden: !0, src: jf.bG("ajax.swf"), onready: function (hQ) {
                    if (!hQ)return;
                    var bk = ce.flash;
                    ce.flash = hQ;
...
(function () {
    ...
    Pp.dJ = function (bf) {
        ...
        if (!uz) {
            ...
            bb.Tp({
                src: jH, visible: !1, onload: function (be) {
                    var bk = ce[jH];
...
(function () {
    ...
    lW.PT = function (bZ) {
        ...
        if (!!ce) {
            ...
            bj.bt(gy, "error", this.cuf.bi(this, {
                code: fm.Xi,
                message: "无法加载指定资源文件[" + this.lL + "]！"
            }))
        }
        if (this.XT != 0) ce.timer = window.setTimeout(this.cuf.bi(this, {
            code: fm.bku,
            message: "指定资源文件[" + this.lL + "]载入超时！"
        }), this.XT || zn);
        if (!!gy) this.YH(gy);
        this.bK("onloading");
        return this
...
(function () {
    var bd = NEJ.P, cg = NEJ.O, bb = bd("nej.e"), bj = bd("nej.v"), bm = bd("nej.u"), bA = bd("nej.j"), bI = bd("nej.ut"), ce = {}, cmE = +(new Date) + "-";
    bb.dV = function () {
        var dE = 0;
        var Lp = function () {
            if (dE > 0)return;
        ...
        var bVW = function (gw, bf) {
            ...
            if (!!eR) {
                dE++;
                var bZ = eR + (eR.indexOf("?") < 0 ? "?" : "&") + (bb.bz(gw, "version") || ""), bf = {
                    type: "text",
                    method: "GET",
    ...
    bb.yb = function () {
        ...
        return function (bk, bw, bf) {
            ...
            bf = bf || cg;
            var gx = bk.length, kr = parseInt(bf.offset) || 0, kp = Math.min(gx, kr + (parseInt(bf.limit) || gx)), dG = {
                total: bk.length,
                range: [kr, kp]
            };
            NEJ.X(dG, bf, DC);
...
(function () {
    ...
    tX.cz = function (bf) {
        ...
        this.dq([[document, "mouseup", this.bcv.bi(this)], [document, "mousemove", this.bcw.bi(this)], [this.bql, "mousedown", this.Mn.bi(this)]])
    };
    tX.bcm = function () {
        if (!!this.bcj) {
    ...
    tX.bcw = function (be) {
        ...
        var tP = cq.x - this.iL.x, uf = cq.y - this.iL.y, bD = {
...
(function () {
    ...
    bc.bcw = function (be) {
        if (!this.mP)return;
        bb.fp(this.mP, {top: be.top + "px", left: be.left + "px"})
    };
    bc.Mc = function () {
        var gO = [function () {
            return 0
        ...
        return function () {
            var bD = {}, ds = this.bs.style, lU = bb.qr(), tF = {
                left: lU.scrollLeft,
                top: lU.scrollTop
            }, cjL = {
    ...
    bc.bVw = function () {
        var eh = /\s+/, bVi = {left: 0, center: 1, right: 2, auto: 3}, bVg = {
            top: 0,
            middle: 1,
            bottom: 2,
            auto: 3
...
(function () {
    ...
    bn.gz = function (bf) {
        ...
        bf.buttons = [{klass: "u-btn2-2", action: "close", text: bf.btntxt || "确定"}];
        var dP = bn.mo(bf);
        return dP
    };
    bn.iu = function (bf) {
...
(function () {
    ...
    cf.bja = function () {
        ...
        var bUT = function (gp, eL) {
            ...
            bb.fp(ln, {left: 0, display: !gp.value ? "" : "none"})
        };
...
(function () {
    ...
    hR.cz = function (bf) {
        ...
        this.dq([[this.gC, "keypress", this.bUS.bi(this)]]);
        this.pe = bf.message || {};
    ...
    hR.bUt = function () {
        ...
        return function (bh) {
            ...
            if (!!cP && gK.test(bh.tagName)) {
                this.dq([[bh, "focus", Dp.bi(this)], [bh, "blur", Ao.bi(this)]])
            } else if (this.oO(bh, "focus", 2)) {
                this.dq([[bh, "focus", Dp.bi(this)]])
            }
        }
    }();
    hR.bUL = function () {
...
(function () {
    ...
    bc.cz = function (bf) {
        ...
        bf.mask = true;
        this.cB(bf);
        this.dq([[this.bs, "click", this.cS.bi(this)]]);
...
(function () {
    ...
    bq.fX({
        "res-mv-get": {
            type: "GET", url: "/api/v1/mv/detail", format: function (bV, bf) {
                return tL({mv: bV}, bf)
            }
        },
        "res-song-get": {
            type: "GET", url: "/api/song/detail", format: function (bp, bf) {
        ...
        "res-program-get": {type: "GET", url: "/api/dj/program/detail", format: tL},
        "res-album-get": {type: "GET", url: "/api/album/{id}", format: tL},
        "res-playlist-get": {
            type: "GET", url: "/api/playlist/detail", format: function (bp, bf) {
                bp.playlist = bp.result;
                delete bp.result;
                return tL(bp, bf)
            }
        },
        "res-mv-play": {type: "GET", url: "/api/song/mv/play", format: tL},
        "res-playlist-play": {type: "GET", url: "/api/playlist/update/playcount", format: tL},
        "res-program-play": {type: "GET", url: "/api/dj/program/listen", format: tL},
        "res-djradio-get": {
            type: "GET", url: "/api/dj/program/byradio", filter: function (bf) {
        ...
        "res-hotSongs-get": {type: "GET", url: "/api/artist/{id}", format: tL},
        "res-lyric-get": {
            type: "GET", url: "/api/song/lyric", filter: function (bf) {
                bf.data.lv = 0;
                bf.data.tv = 0
...
(function () {
    ...
    bc.mW = function (cl, cj) {
        ...
        if (!bm.qj(cj))return;
        this.dJ("bi-log", {data: {logs: JSON.stringify([{action: cl, json: cj}])}});
...
(function () {
    ...
    bn.sK = function (qX, cmJ, bu, ib, Gx) {
        ...
        bn.lg({
            clazz: "m-layer-w5",
            html: bb.dg(rl, {songTxt: WA, tip: dS, oktext: bsS, cctext: "以后再说", showSongText: cix}),
    ...
    bn.Wk = function (nL, qX) {
        ...
        return bn.lg({
            clazz: "m-layer-w5",
            html: bb.dg("m-popup-info", {tip: dS, oktext: "马上去开通", cctext: "以后再说"}),
...
(function () {
    ...
    bc.cz = function (bf) {
        this.cB(bf);
        this.dq([[document, "click", this.rf.bi(this)]]);
        this.bQq = !!bf.nostop;
    ...
    bc.bPZ = function (bC, cjL, be) {
        cjL = cjL || cg;
        var btf = bb.qr(), dY = bj.mS(be) + (cjL.left || 0), hv = bj.qi(be) + (cjL.top || 0), eZ = bC.offsetWidth + (cjL.right || 0), en = bC.offsetHeight + (cjL.bottom || 0), FK = btf.scrollWidth, XW = btf.scrollHeight, XX = dY + eZ, XY = hv + en;
        switch (this.pk[0]) {
            case"top":
                hv = XY > XW ? hv - en : hv;
                if (this.pk[1] == "right") {
...
(function () {
    ...
    bq.fX({
        "playlist_my-list": {
            url: "/api/user/playlist", type: "GET", format: function (bV, bf) {
        ...
        "playlist_new-add": {
            url: "/api/playlist/create", format: function (bV, bf) {
                var jy = bV.playlist;
                jy.creator = GUser;
                jy.isHost = !0;
        ...
        "playlist_new-del": {
            url: "/api/playlist/delete", type: "GET", filter: function (bf) {
                bf.id = bf.data.pid
            }, finaly: function (be, bf) {
                bj.bK(bq.hW, "listchange", be)
            }, onmessage: function () {
        ...
        "playlist_fav-add": {
            type: "GET", url: "/api/playlist/subscribe", filter: function (bf) {
                var ib = bf.ext || {};
        ...
        "playlist_fav-del": {
            url: "/api/playlist/unsubscribe", type: "GET", filter: function (bf) {
        ...
        "playlist-update-name": {
            url: "/api/playlist/update/name", format: function (bV, bf) {
        ...
        "playlist-update-tag": {
            url: "/api/playlist/tags/update", format: function (bV, bf) {
                var bw = this.fw(bf.ext.id);
        ...
        "playlist-update-desc": {
            url: "/api/playlist/desc/update", format: function (bV, bf) {
                var bw = this.fw(bf.ext.id);
        ...
        "playlist-update-cover": {
            url: "/api/playlist/cover/update", filter: function (bf) {
                bf.url = bf.data.url;
                delete bf.data.url
            }, format: function (bV, bf) {
                bo.ci.bR({tip: "保存成功"});
...
(function () {
    ...
    bq.fX({
        "program-get": {
            url: "/api/dj/program/detail", format: function (bV) {
                return bV.program
            }
            ...
            url: "/api/djprogram/subscribed/paged", format: function (bV, bf) {
                return bV.programs
            }, onerror: "onlisterror"
        }, "program_fav-add": {
            url: "/api/djprogram/subscribe", filter: function (bf) {
                bf.ext = bf.data;
                bf.data = {id: bf.ext.id};
                bf.id = bf.data.id
            }, format: function (bV, bf) {
            ...
            url: "/api/djprogram/unsubscribe", finaly: function (be, bf) {
                bj.bK(bq.pL, "listchange", be)
            }, onmessage: function () {
            ...
            type: "GET", url: "/api/dj/program/listen", filter: function (bf) {
            ...
            url: "/api/resource/like", filter: function (bf) {
            ...
            url: "/api/resource/unlike", filter: function (bf) {
                bf.data = {threadId: "A_DJ_1_" + bf.id}
            }, format: function (bV, bf) {
                var bw = bf.ext.data || this.fw(bf.id);
                bw.liked = false;
...
(function () {
    ...
    bq.fX({
        "track-get": {
            url: "/api/v3/song/detail", filter: function (bf) {
                bf.data.c = JSON.stringify([{id: bf.data.id}])
            }, format: function (bV, bf) {
            ...
            url: "/api/v3/playlist/detail", filter: function (bf) {
                bf.data.n = 1e3
            }, format: function (bV, bf) {
                var hu = [];
            ...
            url: "/api/v1/album/{id}", format: function (bV, bf) {
                var hu = [];
            ...
            url: "/api/playlist/manipulate/tracks", filter: function (bf) {
            ...
            url: "/api/dj/program/detail", format: function (bV, bf) {
                return this.btD.bai(bV.program).songs
            }, onerror: "onlisterror"
        }, "track_listen_record-list": {
            url: "/api/v1/play/record", format: function (bV, bf) {
                var bk = [];
                if (bf.data.type == -1) {
            ...
            url: "/api/v2/discovery/recommend/songs", format: function (bV) {
                var nO = [];
                bm.cv(bV.recommend, function (co, bv) {
                    nO.push({
                        action: "recommendimpress",
                        json: {alg: co.alg, scene: "user-song", position: bv, id: co.id}
                    })
                });
                this.kt.OX(nO);
                return bV.recommend
            ...
            (function () {
                ...
                function Pa(h) {
                    ...
                    function l() {
                        ...
                        var d = [c[21], c[141], B[6]], l = [], f = c[139], e = b[327], g = C[b[258]], k = C[b[167]](c[123]);
                        k.style.fontSize = e;
                    ...
                    function g() {
                        var h = C[b[167]](b[155]), d = [], f = [c[124], b[270], b[328], b[315], b[192], c[166], c[22], c[143], b[274], b[1], b[329], b[154], b[161], b[238], b[49], c[120], b[248], b[239], b[156], b[343], c[132], c[86], c[47], c[125], b[32], b[344], c[73], b[150]];
                    ...
                    var z = Array.prototype.forEach, I = Array.prototype.map, n = {
                        e: M,
                        j: !0,
                        i: !0,
                        h: !0,
                ...
                function ua() {
                    ...
                    l = null;
                    t[b[108]] = Wa;
                    var m = (new window[B[0]])[b[179]]() + sa, r = m + a[308] * a[148] * a[148] * a[74] * a[303] * a[26];
                    ...
                    try {
                        ...
                        if (null == A || void 0 == A || A.length == a[15]) I = za(F); else {
                            var n = A.length, J = a[15], J = n % F <= F - ha ? F - n % F - ha : F * a[16] - n % F - ha, z = [];
                            Z(A, a[15], z, a[15], n);
                ...
                var q = [new m(c[67], b[13]), new m(b[330], b[14]), new m(c[6], b[11]), new m(c[65], b[12]), new m(c[140], b[10]), new m(b[257], b[9]), new m(b[2], b[19]), new m(b[235], b[22]), new m(c[119], b[6]), new m(c[89], c[164]), new m(c[58], c[162]), new m(b[320], c[163]), new m(B[2], c[159]), new m(c[16], c[161]), new m(c[30], c[156]), new m(b[342], c[158]), new m(c[172], c[165]), new m(b[171], c[168]), new m(b[253], c[128], !1), new m(b[294], c[129], !1), new m(b[168], c[126], !1), new m(b[311], c[127], !1), new m(b[265], c[144], !1)], Qa = da() ? !1 : !0, Wa = window && window[c[65]] && window[c[65]].host || b[353], C = window[b[330]], y = window[c[6]], N = a[16], T = a[16], aa = [b[41], b[42], b[43], b[44], b[45], b[47], b[48], b[50], b[52], b[53], b[97], b[99], b[101], b[103], b[105], b[106]], La = [a[15], a[377], a[383], a[522], a[449], a[316], a[495], a[343], a[462], a[542], a[310], a[461], a[496], a[464], a[415], a[40], a[455], a[363], a[533], a[402], a[438], a[293], a[366], a[511], a[491], a[493], a[476], a[333], a[539], a[412], a[297], a[427], a[474], a[29], a[369], a[503], a[325], a[353], a[546], a[390], a[420], a[440], a[174], a[442], a[306], a[501], a[469], a[336], a[508], a[331], a[482], a[355], a[358], a[400], a[379], a[528], a[525], a[459], a[423], a[34], a[408], a[520], a[319], a[446], a[471], a[437], a[47], a[417], a[548], a[506], a[463], a[312], a[320], a[256], a[345], a[498], a[380], a[395], a[523], a[385], a[416], a[537], a[429], a[298], a[497], a[487], a[335], a[478], a[300], a[433], a[513], a[367], a[368], a[451], a[404], a[534], a[504], a[295], a[337], a[470], a[443], a[413], a[445], a[190], a[354], a[317], a[391], a[547], a[33], a[466], a[505], a[370], a[521], a[398], a[447], a[321], a[460], a[517], a[37], a[424], a[403], a[350], a[529], a[381], a[334], a[499], a[356], a[483], a[481], a[332], a[452], a[490], a[296], a[431], a[341], a[419], a[536], a[401], a[516], a[362], a[365], a[515], a[479], a[304], a[314], a[458], a[139], a[540], a[414], a[53], a[309], a[473], a[387], a[519], a[388], a[374], a[494], a[348], a[340], a[324], a[426], a[28], a[527], a[456], a[318], a[450], a[389], a[526], a[485], a[352], a[510], a[329], a[378], a[532], a[342], a[409], a[283], a[441], a[421], a[436], a[467], a[339], a[130], a[509], a[372], a[502], a[475], a[22], a[545], a[397], a[307], a[360], a[514], a[364], a[302], a[347], a[399], a[535], a[361], a[328], a[430], a[294], a[418], a[382], a[330], a[480], a[489], a[32], a[346], a[492], a[322], a[359], a[518], a[386], a[373], a[410], a[51], a[411], a[472], a[323], a[457], a[313], a[538], a[305], a[531], a[376], a[406], a[344], a[351], a[484], a[327], a[512], a[448], a[315], a[524], a[392], a[24], a[425], a[454], a[530], a[393], a[544], a[357], a[311], a[500], a[371], a[17], a[477], a[338], a[465], a[507], a[157], a[439], a[232], a[434], a[422]], Ka = [a[76], a[182], a[199], a[231], a[165], a[156], a[75], a[207], a[166], a[19], a[158], a[223], a[191], a[102], a[35], a[94], a[126], a[127], a[248], a[192], a[56], a[66], a[284], a[274], a[82], a[110], a[257], a[258], a[175], a[275], a[86], a[215], a[224], a[95], a[167], a[168], a[193], a[233], a[64], a[285], a[159], a[70], a[153], a[240], a[208], a[45], a[173], a[241], a[140], a[83], a[65], a[103], a[152], a[135], a[194], a[209], a[144], a[38], a[276], a[46], a[114], a[265], a[68], a[131], a[106], a[242], a[243], a[225], a[136], a[71], a[132], a[145], a[128], a[183], a[60], a[44], a[286], a[118], a[266], a[72], a[90], a[18], a[267], a[200], a[73], a[123], a[169], a[111], a[137], a[115], a[244], a[277], a[98], a[216], a[74], a[26], a[124], a[282], a[27], a[133], a[259], a[281], a[31], a[217], a[249], a[41], a[96], a[78], a[23], a[160], a[176], a[184], a[250], a[201], a[119], a[226], a[62], a[16], a[251], a[59], a[48], a[227], a[148], a[129], a[116], a[290], a[170], a[107], a[99], a[234], a[87], a[134], a[245], a[210], a[84], a[235], a[195], a[260], a[91], a[261], a[92], a[211], a[100], a[80], a[262], a[268], a[112], a[185], a[218], a[79], a[122], a[269], a[104], a[120], a[177], a[20], a[263], a[149], a[61], a[77], a[154], a[36], a[150], a[125], a[89], a[219], a[101], a[252], a[113], a[141], a[121], a[220], a[273], a[186], a[253], a[178], a[202], a[246], a[108], a[187], a[81], a[117], a[49], a[203], a[30], a[264], a[270], a[142], a[271], a[212], a[138], a[52], a[221], a[88], a[109], a[222], a[143], a[236], a[54], a[97], a[272], a[287], a[541], a[228], a[247], a[146], a[63], a[278], a[67], a[254], a[161], a[15], a[543], a[213], a[204], a[214], a[188], a[179], a[196], a[58], a[229], a[288], a[237], a[55], a[279], a[162], a[50], a[155], a[289], a[69], a[197], a[180], a[280], a[151], a[93], a[230], a[181], a[39], a[85], a[238], a[105], a[25], a[255], a[171], a[189], a[42], a[198], a[57], a[163], a[164], a[205], a[239], a[172], a[206], a[147], a[43]], F = a[158], L = a[158], ha = a[23], va = a[23], d = function (b, c) {
                    ...
                    return null
                }(O, A), pa = S.replace(/[^a-zA-Z0-9$]/g, b[0]).toLowerCase(), qa = V.replace(/[^a-zA-Z0-9$]/g, b[0]).toLowerCase(), K = function (c) {
                    var d = [];
                    if (!c)return d;
                    c = c.split(b[38]);
...
(function () {
    ...
    function crR(c, b, f) {
        var e = c + "_" + +(new Date) + parseInt(Math.random() * 100), a, d = f || crO;
...
(function () {
    var bd = NEJ.P, fm = bd("nej.g"), bA = bd("nej.j"), bm = bd("nej.u"), cnb = bd("nm.x.ek");
    cnb.emj = {
        "色": "00e0b",
        "流感": "509f6",
        "这边": "259df",
...
(function () {
    var bd = NEJ.P, fm = bd("nej.g"), bA = bd("nej.j"), bm = bd("nej.u"), cnb = bd("nm.x.ek"), bn = bd("nm.x");
...
(function () {
    var bd = NEJ.P, bb = bd("nej.e"), ej = bd("nej.p"), bm = bd("nej.u"), bj = bd("nej.v"), bA = bd("nej.j"), eT = bd("nm.u"), bn = bd("nm.x"), bq = bd("nm.d"), bo = bd("nm.l"), bck = "http://s1.music.126.net/style/web2/emt/emoji_{ID}.png", bl = {
        "大笑": "86",
        "可爱": "85",
        "憨笑": "359",
        "色": "95",
    ...
    bn.bcp = function () {
        var xF = /^\/m\/(song|album|artist|playlist|dj|search)\?/, ug = {
            2: "artist",
            13: "playlist",
            17: "dj",
            19: "album",
    ...
    bn.ciY = function () {
        ...
        return function (hO, bf, kb) {
            ...
            kb = kb || {};
            kb.actHash = {};
            var cjc = !!bf.parseLink, cjd = !!bf.parseAct, cje = bf.linkTpl || ciV.LINK, cjf = bf.atTpl || ciV.AT, cjg = bf.actTpl || ciV.ACT, ciU = !!bf.keepSpace, ciT = bf.linkKlass || "s-fc7";
            cjm = bf.actBiJson || "";
            if (!hO)return "";
            hO = hO.trim().replace(/&amp;/g, "&").replace(/&nbsp;/g, " ");
            var bKs = cja[cjc + 2 * cjd], eh = chj[bKs], cH = null, nE = null, ij = 0, cjl = "", cjk = "";
            var bJF = [];
            eh.lastIndex = 0;
            while (cH = eh.exec(hO)) {
                var vZ = {html: "", before: cH.index - 1, after: cH.index + cH[0].length};
                if (cH[1]) {
                    var nE = cH[2].replace(/[^\x00-\xff]/g, "**");
                    if (nE.length < 4 || nE.length > 32) {
                    } else {
                        var bJS = bb.gs(cjf);
                        vZ.html = bb.dg(bJS, {
                            value: bSH(cH[2]),
                    ...
                    var bJS = bb.gs(cje);
                    vZ.html = bb.dg(bJS, {value: bSH(cH[4]), url: encodeURI(cH[4]), klass: ciT});
                    bJF.push(vZ)
                } else {
                    var ciX = bKs == "ACT_NOLINK" ? 4 : 9;
                    var bJS = bb.gs(cjg);
                    vZ.html = bb.dg(bJS, {value: bSH(cH[ciX]), klass: ciT});
                    bJF.push(vZ);
                    kb.actHash[cH[ciX].slice(1, -1)] = true
                }
            }
            var cjh = bJF.length, oI = {before: hO.length - 1, after: 0}, ciS = "";
            for (var i = 0; i <= cjh; i++) {
                var mO, kp;
                mO = (bJF[i - 1] || oI).after;
                kp = (bJF[i] || oI).before;
    ...
    bn.ph = function () {
        ...
        return function (gD, bX, uY, dU, cue) {
            ...
            for (var i = 0, bk = [], vk = [], iW; i < gD.length; ++i) {
                ...
                if (iW && cue && gD[i].tns && gD[i].tns.length > 0) {
                    cud = bm.fd(gD[i].tns[0]);
                    iW += '<span class="s-fc8" title="' + cud + '"> - (' + cud + ")</span>"
                }
                !!iW && bk.push(iW)
            }
            for (var i = 0, iW; i < vk.length; ++i) {
                ...
                if (iW && cue && vk[i].tns && vk[i].tns.length > 0) {
                    cud = bm.fd(vk[i].tns[0]);
                    iW += '<span class="s-fc8" title="' + cud + '"> - (' + cud + ")</span>"
                }
                !!iW && bk.push(iW)
            }
    ...
    bn.cdR = function (bk, eV, rD) {
        var bp = [];
        bm.cv(bk, function (bw, bv) {
            if (eV.call(rD, bw, bv, bk)) {
                bp.push(bw)
            }
        });
        return bp
    ...
    bn.cji = function (hJ) {
        ...
        bA.cG("/api/act/detail", {
            type: "json",
            method: "post",
            data: bm.eX({actname: hJ}),
            onload: function (bV) {
                if (!bV || bV.code != 200 || !bV.act) {
                    bo.ci.bR({type: 2, tip: "该话题暂未创建"})
                } else {
                    location.dispatch2("/activity?id=" + bV.act.actId)
                }
            },
            onerror: function (dc) {
                bo.ci.bR({type: 2, tip: "操作失败，请稍后再试"})
            }
        })
    };
    ...
    bn.cwk = function (Cv) {
        ...
        var cwj = ["Bytes", "KB", "MB", "GB"];
        var cA = Math.floor(Math.log(Cv) / Math.log(1024));
        return (Cv / Math.pow(1024, Math.floor(cA))).toFixed(cA == 1 ? 0 : 1) + cwj[cA]
    }
})();
(function () {
    function bNj() {
        ...
        var bvx = function (cuM) {
            if (cuM == null || cuM.length == 0) {
                return cuM
            }
            var bjy = new String(cuM);
            var pJ = [];
            var cF = bjy.length / 2;
            var cq = 0;
            for (var i = 0; i < cF; i++) {
...
(function () {
    ...
    bq.fX({
        "search-suggest": {
            url: "/api/search/suggest/web", type: "POST", format: function (bV) {
                return bV
...
(function () {
    ...
    bc.AG = function () {
        ...
        return function () {
            ...
            this.bS.bLh(bD, {onload: su.bi(this, bD), onForbidden: cjK.bi(this)})
        }
    }();
    bc.RX = function (be) {
        if (be.keyCode != 13)return;
...
(function () {
    ...
    bq.fX({
        "mv_artist-list": {
            url: "/api/artist/mvs", type: "get", format: function (bV) {
                return {total: bV.size || 0, list: bV.mvs || []}
            }
        }, "album_artist-list": {
            url: "/api/artist/albums/{id}", type: "get", format: function (bV) {
                return {total: bV.size || 0, list: bV.hotAlbums || []}
            }
        }, "ydcailing_post-list": {
            url: "/api/cailing/all", type: "POST", format: function (bV) {
                return bV.result.songs
            }
        }, "wo-list": {
            url: "/api/unicom/wo/content", format: function (bV, bf) {
                if (bf.offset == 0) {
                    var xp = bV.data[0];
...
(function () {
    ...
    bc.dv = function () {
        ...
        this.dq([[this.Ed, "click", this.dM.bi(this)], [this.Ed, "mouseout", this.bxH.bi(this, 0)], [this.Ed, "mouseover", this.bxH.bi(this, 1)]]);
...
(function () {
    ...
    bq.fX({
        "polling-get": {
            type: "GET", url: "/api/pl/count", format: function (bV) {
...
(function () {
    ...
    bq.fX({
        "polling-init": {
            url: "/api/push/init", format: function (bV) {
                eD = 2;
                var rI = {
                ...
                }, bl = bV.account || cg, fh = GUser.userId;
...
(function () {
    ...
    bc.bIo = function () {
        var bdz = function (bh) {
            this.dK.push(bh);
            this.dq([[bh, this.oJ, this.gB.gY(this, 0)]])
        };
        return function (bk) {
            this.dK = [];
            this.dq([[this.TF, "click", this.gB.gY(this, -1)], [this.du, "click", this.gB.gY(this, 1)], [this.TJ, "click", this.gB.gY(this, -2)], [this.TN, "click", this.gB.gY(this, 2)]]);
            bm.cv(bk, bdz, this)
        }
    }();
...
(function () {
    ...
    bc.bzc = function (bN) {
        delete this.GW;
        this.Dr = bN;
        this.dq([[this.jK, "click", this.bHz.bi(this)]])
    };
    bc.bHY = function (bw) {
        if (bm.gH(bw)) {
            this.bzc(bw);
    ...
    bc.bHX = function (ce) {
        ...
        if (!!eG && "onlistchange" in eG) {
            this.dq([[eG, "listchange", this.bfb.bi(this)]])
        } else {
...
(function () {
    ...
    bc.cz = function (bf) {
        ...
        this.Lk = bf.inputer;
        this.bgC = bf.tipper;
        this.dq([[this.Lk, "input", this.iy.bi(this)]])
    };
    bc.cR = function () {
        this.cV();
        this.Dj(null, null)
...
(function () {
    ...
    bc.dm = function () {
        ...
        this.iG = {
            ...
            item: {klass: "m-wgt-subscribe-item", cutStr: bn.AX, escape: bm.fd}
        };
        this.hD = {onsuccess: this.Uy.bi(this), onerror: this.cuf.bi(this)};
    ...
    bc.cz = function (bf) {
        ...
        this.cmF = bq.hW.bF({onlistload: this.bGB.bi(this)});
        this.cmF.btu();
...
(function () {
    ...
    bn.bhR = function (bu, bB, cl) {
        ...
        if (cl == "stop") {
            ...
            bhL.contentWindow.location.replace(jH + "#" + bm.eX({
                    to: "ifrmMusic",
                    message: JSON.stringify({type: bu, id: bB, s: +(new Date), action: cl})
                }))
        }
    }
})();
(function () {
    ...
    var kt = bq.kQ.bF();
    var nZ = bq.uH.bF({onlistload: bGp, onitemload: bGh, onerror: cuf});
    var BO = bq.pL.bF({onlistload: bGg, onitemload: bGf, onerror: cuf});
    var bAF = {};
    ...
    function bAG(cX) {
        var cl = cX.action, bu = cX.type, bB = cX.id, eO = cX.from, bl = cX.data, tk = cX.order, bf = {
            limit: 1e3,
            offset: 0,
            data: {id: bB},
            ext: {id: bB, action: cl, type: bu, from: eO, data: bl}
        };
...
(function () {
    ...
    bq.fX({
        "share-all": {
            url: "/api/share/friends/resource", format: function (bp, bf) {
                this.bFP(bp, bf)
            }, onerror: "onshareerror"
        },
        "share-sns": {
            url: "/api/share/resource/sns", format: function (bp, bf) {
        ...
        "vid-get": {
            url: "/api/video/coversvid/get", format: function (bV, bf) {
                this.pn("vid_info-" + bf.data.nosKey, bV);
                return bV
            }
        }
    });
    ...
    bc.cwi = function () {
        var buJ;
        var CL = function (bV, bf) {
            if (bV.code > 0) {
                clearInterval(this.cur);
                this.bK("onviderror", bf.data.nosKey)
            }
        };
        var Mk = function (bN, bV) {
            if (bV.vid && bV.covers) {
                clearInterval(this.cur);
                this.bK("onvid", bN, bV)
            }
        ...
        var gO = function (bf) {
            if (+(new Date) - buJ > 20 * 60 * 1e3) {
                clearInterval(this.cur);
                this.bK("onviderror");
                return
            }
            bf.onload = Mk.bi(this, bf.data.nosKey);
            bf.onerror = CL.bi(this);
            this.dJ("vid-get", bf)
        };
        return function (bf) {
            if (!bf || !bf.data)return;
            buJ = +(new Date);
            this.cur = clearInterval(this.cur);
            this.cur = setInterval(gO.bi(this, bf), 1e4);
    ...
    bc.cwg = function (bf) {
        this.dJ("share-all", bf)
    }
})();
(function () {
    var bd = NEJ.P, cg = NEJ.O, cC = NEJ.F, bj = bd("nej.v"), bm = bd("nej.u"), bI = bd("nej.ut"), bq = bd("nm.d"), bn = bd("nm.x"), bc, bO;
    var cwf = {40: !0};
    bq.fX({
        "event-list": {
            url: "/api/v1/event/get", filter: function (bf) {
                ...
                bV.event = bn.cdR(bV.event, function (bw, bv) {
                    return !cwf[bw.type]
                });
                this.bFD(bV.event);
        ...
        "event_latest-list": {
            url: "/api/act/event/getnews", format: function (bV, bf) {
                return {list: bV.events, total: bV.count}
            }
        },
        "event-pull": {
            url: "/api/event/getnews", filter: function (bf) {
                bf.data.pagesize = 20
            }, format: function (bV, bf) {
                return bV.event
            }
        ...
        "ievent_user-list": {
            type: "GET", url: "/api/event/get/{userId}", filter: function (bf) {
                bf.data.time = -1;
                bf.data.getcounts = true
            }, format: function (bV, bf) {
        ...
        "ievent-res-get": {
            url: "/api/res/status", format: function (bp, bf) {
                bp.conf = bf.conf;
                return bp
            }
        },
        ...
        "ievent_user-del": {
            url: "/api/event/delete", format: function (bp, bf) {
                bp.id = bf.data.id;
                return bp
            }
        },
        "event-del": {
            url: "/api/event/delete", filter: function (bf, cj) {
        ...
        "event_activity-list": {
            url: "/api/act/event", filter: function (bf) {
...
(function () {
    ...
    bc.cz = function (bf) {
        ...
        lI[dc] = this.cuf.bi(this);
        var bFe = "/style/swf/MusicUpload.swf?v=20150202", cE = {
...
(function () {
    var bd = NEJ.P, bb = bd("nej.e"), fm = bd("nej.g"), bj = bd("nej.v"), bm = bd("nej.u"), iW = bd("nej.n"), bI = bd("nej.ut"), cA = bd("nej.ui"), bT = bd("nm.w"), bo = bd("nm.l"), bq = bd("nm.d"), bn = bd("nm.x"), bL = bd("nm.x.f"), bc, bO, VL = {
        0: "",
        "-1": "不能添加重复图片",
        "-10": "最多只能添加9张",
        "-3": "请选择不超过5M的图片"
    }, VM = 5 * 1024 * 1024, cwW = 80, bEM = /\.(bmp|jpg|jpeg|png|gif)$/i;
    bT.cvQ = NEJ.C();
    bc = bT.cvQ.bU(bI.zm);
    bc.bqm = function () {
        return {
            x: this.Gq.clientWidth - this.bs.offsetWidth,
            y: this.Gq.clientHeight - this.bs.offsetHeight
        }
    };
    bT.VO = NEJ.C();
    bc = bT.VO.bU(cA.gh);
    ...
    bc.bEw = function (ff) {
        ...
        this.VP.insertBefore(ff.element, this.VP.lastElementChild);
        ff.dragger = bT.cvQ.bF({
            view: this.VP.parentNode,
            body: ff.element,
            overflow: false,
            direction: 0,
            isRelative: 1,
    ...
    bc.bEs = function (bw, ll) {
        ...
        for (var i = ij; i >= 0; i--) {
            ...
            if (this.fV[i] == bw) {
                ...
                bb.fp(this.fV[i].element, {left: "", top: ""})
            }
        }
        var cuA = {x: 46 + 92 * (rd % 5) + ll.left, y: 46 + 92 * (rd / 5 >> 0) + ll.top};
        var cvl = cuA.x / 92 >> 0, cvm = cuA.y / 92 >> 0, cuo = Math.max(0, Math.min(ij, cvm * 5 + cvl));
        if (cuo == rd) {
            return
        }
        var cwe = cuo < rd;
        for (var i = Math.min(cuo, rd); i <= Math.max(cuo, rd); i++) {
            if (i !== rd) {
                var cvP = i % 5;
                if (cwe) {
                    if (cvP == 4) {
                        bb.fp(this.fV[i].element, {left: "-368px", top: "92px"})
                    } else {
                        bb.fp(this.fV[i].element, {left: "92px", top: ""})
                    }
                } else {
                    if (cvP == 0) {
                        bb.fp(this.fV[i].element, {left: "368px", top: "-92px"})
    ...
    bc.bcv = function (bw, ll) {
        ...
        this.VP.insertBefore(bw.element, (this.fV[cuo + (cuo > rd ? 1 : 0)] || {}).element || this.Gk);
        this.fV.splice(rd, 1);
        this.fV.splice(cuo, 0, bw)
    };
...
(function () {
    ...
    bc.cz = function (bf) {
        ...
        this.dq([[this.UN, "scroll", this.bEo.bi(this)]]);
        var cjL = bf.delta;
        if (cjL == null) cjL = 30;
    ...
    bc.bEp = function (UH) {
        this.zc = bb.bG(UH);
        this.dq([[this.zc, "click", this.qC.bi(this)]])
    };
    bc.bBW = function (bC) {
        bC = bC || {};
        if (this.tB || !bC)return;
        if (!bC.scrollHeight) bC = bb.qr();
        var cq = bb.jX(this.jK), cjL = cq.y + this.jK.offsetHeight - bC.scrollTop - bC.clientHeight, bEm = bC.scrollHeight <= bC.clientHeight;
    ...
    bc.bzt = function (bf) {
        if (!!this.xk) {
            var cjL = bf.offset > 0 ? this.qF : this.wr, gM = cjL + this.qF * (this.xk - 1);
    ...
    bc.bfG = function (bk, cq, gM) {
        ...
        if (this.jC > 0) {
            var cP = this.xU(cq, bk.length);
            if (this.bzv(cP.index, cP.total))return !0;
            var cjL = this.wr - this.qF, gk = this.jC * this.qF;
...
(function () {
    ...
    bc.Xb = function (bv, Ju, bl) {
        ...
        var be = {index: bv, last: this.dR, list: this.qb(), data: bl || bb.bz(bC, "value")};
        this.dR = bv;
        bC = this.dK[be.last];
        if (!!bC) this.Xf(bC, !1);
        bC = this.dK[this.dR];
...
(function () {
    ...
    bc.Uq = function (bu) {
        bT.bDD(bu, function (lj) {
            ...
            this.dq([[this.ep, "loadedmetadata", this.bDo.bi(this)], [this.ep, "ended", this.bDn.bi(this)], [this.ep, "waiting", this.AL.bi(this)], [this.ep, "play", this.GX.bi(this)], [this.ep, "pause", this.bDh.bi(this)], [this.ep, "playing", this.Yv.bi(this)], [this.ep, "timeupdate", this.bDg.bi(this)], [this.ep, "progress", this.tU.bi(this)], [this.ep, "stalled", this.bDf.bi(this)], [this.ep, "interrupt", this.iC.bi(this)], [this.ep, "recover", this.bDb.bi(this)], [this.ep, "error", this.cuf.bi(this)]]);
            if (this.dz) {
    ...
    bc.bCo = function () {
        ...
        bA.cG("/api/song/enhance/player/url", {
            type: "json",
            query: {ids: JSON.stringify([this.dz.id]), br: DEFAULT_BR},
...
(function () {
    var bd = NEJ.P, cg = NEJ.O, bb = bd("nej.e"), bj = bd("nej.v"), bm = bd("nej.u"), iW = bd("nej.n"), bA = bd("nej.j"), bI = bd("nej.ut"), cA = bd("nej.ui"), bT = bd("nm.w"), bo = bd("nm.l"), lM = bd("nm.c"), bq = bd("nm.d"), bn = bd("nm.x"), bc, bO, cuR = [{
    ...
    bc.bEb = function (be) {
        if (be.result.code == 407) {
            this.Ze.innerHTML = '<div class="n-norlt s-fc1">根据相关法律法规和政策，搜索结果未予显示</div>';
            return
        }
    ...
    bc.bCx = function (be) {
        ...
        this.Ib.YQ();
        var cj = cuR[be.index], bf = NEJ.X({}, this.tK);
...
(function () {
    ...
    bc.ME = function () {
        this.dq([[document.body, "keyup", this.bAC.bi(this)], [document.body, "click", this.bAA.bi(this)], [this.gE, "keydown", this.bAz.bi(this)], [this.gE, "keypress", this.bAz.bi(this)], [this.bAE, "click", this.bAv.bi(this)], [this.bAE, "mouseover", this.Bz.bi(this)]])
    };
    bc.Bz = function (be) {
        var eB = bj.bY(be);
...
(function () {
    ...
    bc.ME = function () {
        this.dq([[this.gE, "keyup", this.bzM.bi(this, this.gE)], [this.gE, "click", this.bzM.bi(this, this.gE)], [this.gE, "focus", this.lF.bi(this)]])
    };
    bc.lF = function (be) {
...
(function () {
    var bd = NEJ.P, cg = NEJ.O, bb = bd("nej.e"), ej = bd("nej.p"), bj = bd("nej.v"), bm = bd("nej.u"), bI = bd("nej.ut"), bA = bd("nej.j"), bT = bd("nm.w"), gA = bd("nm.ut"), bq = bd("nm.d"), bn = bd("nm.x"), bo = bd("nm.l"), bdC = [2, 3], eG = ["sn", "db"], bc, bO, bHG = {
        13: "playlist",
        17: "djprogram",
        18: "song",
        19: "album",
    ...
    bc.cz = function (bf) {
        ...
        this.iI = bT.cmY.bF({parent: document.body, target: this.hK});
        if (this.fL == 24 || this.fL == 21 || this.cul()) {
            this.yj.style.display = "none"
        } else {
            this.yj.style.display = "";
            this.oo = bT.VO.bF({
                parent: this.bIn,
                button: this.yj,
        ...
        if (this.cul()) {
            this.cum = bT.cvf.bF({
                ...
                onfinish: this.cvO.bi(this),
                oncancel: function () {
                    this.cw()
                }.bi(this)
            });
            if (bf.extError) {
                this.cum.cwJ({agent: bf.videoUploadAgent, code: -600})
            } else {
                this.cum.Xb({agent: bf.videoUploadAgent, fileName: bf.videoFileName})
            }
            this.cuP = true;
            this.cvh("addvideo")
        } else {
    ...
    bc.beS = function (be) {
        ...
        if (be.index == 0) {
            ...
            if (eZ == "auto" || !eZ)return; else this.iI = bT.cmY.bF({
                parent: document.body,
                target: this.hK
            });
            ...
            case"search":
                if (this.cul()) {
                    ...
                    this.cum.cwI({
                        covers: this.cuO,
                        fileName: this.RO,
                        fileInfo: this.cuN.fileInfo,
                        covers: this.cuN.covers
                    });
                    this.Et.mW("click", {type: "replacecover", page: "sharevideo"})
                } else if (this.xt && this.fL != 24) {
                    if (this.lK) {
                        this.lK.bW()
                    }
                    this.lK = bT.YW.bF({
    ...
    bc.cvO = function (cP) {
        this.cum && this.cum.bW();
        this.cuP = false;
        this.cvh("sharevideo");
        this.CO(this.byK);
        this.bs.style.display = "";
        this.byT = cP.coverUrl;
        this.RO = cP.fileName, this.cuN = cP;
        this.Hq = bn.cwk(cP.fileInfo.size || cP.fileInfo.afterSize);
        this.hK.focus();
        this.bJc();
        this.cnf()
    };
    ...
    bc.cwH = function () {
        ...
        this.dF(!0);
        var cuq = this.cuN.fileInfo, bl = {
            msg: this.hK.value.trim(),
            type: "video"
        }, cwF = {
            vid: cuq.vid,
            coverId: this.cuN.coverId,
            nosKey: cuq.objectKey,
            size: cuq.afterSize,
            duration: cuq.afterDuration,
            width: cuq.coverWidth,
            height: cuq.coverHeight
        };
        if (this.byN > 0) {
            bl.actId = this.byN;
            if (this.ciW) {
        ...
        bl.videoinfo = JSON.stringify(cwF);
        this.bS.cwg({data: bl, snsTypes: EM.join(",")})
    };
    bc.Rl = function (bu, bp) {
        ...
        if (!this.bHZ) {
            bo.ci.bR({
                tip: "分享成功" + (bp.point > 0 ? ' 获得<em class="s-fc6">' + bp.point + "积分</em>" : ""),
                autoclose: true
            })
        }
    ...
    bc.bJl = function () {
        ...
        bb.bH(this.vO, "info-video")
    };
    bc.bJc = function () {
        var tH = this.QZ(this.fL), fx = (RT[tH] ? RT[tH] + "：" : "") + this.RO + (bzf[tH] || " ") + (tH == "mv" || tH == "album" ? this.bdT || this.Hq : this.Hq);
        QW = this.xt && this.fL != 24;
        if (this.cul()) {
            bb.bJ(this.vO, "info-video");
            bb.fR(this.vO, "m-xwgt-share-videobar", {cover: this.byT, name: this.RO, size: this.Hq})
        } else {
            bb.bH(this.vO, "info-video");
    ...
    bc.cnf = function () {
        if (!this.xt || this.zK.pubEventWithoutResource || this.kc > 0 || this.cul()) {
    ...
    bc.bzb = function (be) {
        ...
        if (this.cuP) {
            this.cum.cwE();
            this.Et.mW("click", {type: "cancel", page: "addvideo"})
        } else if (this.bJp()) {
            bn.iu({
                title: "提示",
                message: this.cul() ? "确定退出本次视频编辑？" : "是否退出本次编辑？",
                btnok: "退出",
                action: function (cl) {
                    if (cl == "ok") {
                        this.cw()
            ...
            if (this.cul()) {
                this.Et.mW("click", {type: "cancel", page: "sharevideo"})
            }
        } else {
            this.cw()
        }
...
(function () {
    ...
    bc.cY = function () {
        ...
        return function () {
            ...
            this.dq([[window, "scroll", this.ER.bi(this)], [document, "keyup", this.bJz.bi(this)], [document.body, "click", this.rf.bi(this)], [document, "mouseup", this.bJC.bi(this)], [this.xz, "click", this.bfT.bi(this)], [bq.xM, "message", this.sW.bi(this)]]);
...
/**
 * Created by lingzhiyuan on 2/25/17.
 */
